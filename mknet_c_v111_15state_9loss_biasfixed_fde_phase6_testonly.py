...
if __name__ == '__main__':
    ...
    print(f'Test-only checkpoint: {CHECKPOINT_PATH}')
    ...
    # Evaluate the loaded checkpoint once on the original validation interval.
    # No backward pass or optimizer step occurs in this test-only variant.
