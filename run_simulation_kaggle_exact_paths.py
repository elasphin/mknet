...
remove Python/object allocation, redundant deterministic recomputation, unused SP3
derivative work, and IMU/RINEX parsing outside the exact requested fusion window only.
"""
