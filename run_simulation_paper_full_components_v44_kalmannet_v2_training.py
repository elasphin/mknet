...
if __name__ == "__main__":
    ...
    for epoch in range(1, TRAINING_EPOCHS + 1):
        ...
        # KalmanNet V2: short trajectories are independent and shuffled during
        # training.  Chronology is preserved inside each short trajectory.
        ...
        training_history.append({
            "stage": "yan_masked_cla_kalmannet_v2_short_trajectory_latent_alternating",
            "epoch": epoch,
