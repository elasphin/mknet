...
if __name__ == '__main__':
    ...
    filter_parameters = list(model.lstm.parameters())
    filter_parameters += list(model.attention_proj.parameters())
    filter_parameters += list(model.attention_v.parameters())
    filter_parameters += list(model.gain_head.parameters())
    ...
    torch.save({
        ...
        'weight_decay': float(WEIGHT_DECAY),
        'alternating_order': 'theta_filter_then_psi_representation',
        'theta_filter': 'lstm+attention+gain_head',
        'psi_representation': 'masked_conv_parameters',
        'validation_available': True,
