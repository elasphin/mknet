...
class MaskedCLA(nn.Module):
    ...
    residual gyro/accelerometer measurement errors. Yan does not publish eta
    labels/timing, so eta_k is constrained through its teacher-forced NEXT-interval
    navigation-state consequence using Eq. (8)+INS and the same Eq. (30) state
    objective. This is a documented timing/supervision completion, not an
    author-claimed training detail.
