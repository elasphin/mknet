...
class MaskedCLA(nn.Module):
    ...
    def __init__(self, nmax: int, dropout: float=0.2) -> None:
        ...
        # KalmanNet4SensorFusion stability adaptation: use an explicit
        # nonzero Kaiming initialization for the learned Kalman-gain map and a
        # zero bias.  The Masked-CLA architecture and Yan Eq. (30) loss remain
        # unchanged.
...
if __name__ == '__main__':
    ...
    # gain_head is initialized explicitly inside MaskedCLA with Kaiming
    # weights and zero bias, matching the SensorFusion stability pattern.
    ...
    for epoch in range(1, KNET_V2_ALTERNATING_EPOCHS + 1):
        ...
        train_recursive_monitor = _evaluate_actual_closed_loop_training_objective()
        validation_recursive_monitor = _evaluate_actual_closed_loop_validation_objective()
