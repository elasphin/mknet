...
# --- FDE / DIA EXPERIMENT BLOCK --- True enables the Yan/Ref.[33] online FDE/DIA path; False bypasses it with the same raw measurements.
FDE_DIA_ON = True
...
# Project-only Data01-fitted affine feature scaling; Yan does not publish a feature-scaling rule. Targets and navigation equations stay in SI units.
...
if __name__ == '__main__':
    ...
    test_imu_noise = test_imu_models[test_rover.imu_type]
