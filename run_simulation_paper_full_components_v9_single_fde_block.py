...
if __name__ == "__main__":
    ...
    print("LEO residual model: Yan Eq.(3)/(4) + Ref.[35] URA/iono/tropo/MP/receiver-noise, heavy-tailed")
    ...
    summary = {
        ...
        "runtime_checks": {
            "van_loan_fast_calls": int(_VAN_LOAN_STATS["taylor_calls"]),
            "van_loan_exact_calls": int(_VAN_LOAN_STATS["exact_fallback_calls"]),
