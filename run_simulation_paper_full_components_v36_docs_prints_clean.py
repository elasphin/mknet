...
if __name__ == "__main__":
    ...
    print(
        ...
        f"trajectories={trajectory_count}, trajectory_length={TRAINING_TRAJECTORY_LENGTH}, "
        f"batch={TRAJECTORY_BATCH_SIZE}, epochs={TRAINING_EPOCHS}, "
    ...
    def _rollout_actual_closed_loop_trajectory(
        ...
        *,
        ...
        """Differentiable closed-loop rollout of one short Data01 trajectory."""
    ...
    def _run_training_phase(
        ...
        """Run one alternating-optimization phase over short-trajectory mini-batches."""
