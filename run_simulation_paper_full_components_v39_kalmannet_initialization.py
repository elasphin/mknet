...
if __name__ == "__main__":
    ...
    # Yan does not publish a Kalman-gain output initialization. KalmanNet and
    # Latent-KalmanNet construct their gain-producing trainable layers without
    # forcing the gain output to zero, so keep PyTorch's standard initialization.
