...
if __name__ == "__main__":
    ...
    for event in test_timeline:
        ...
        # Training normalization is fixed from Data01 only. The full fixed-Nmax
        # gain head is evaluated at the same padded shape used in training; the
        # current mask selects the valid columns. No Data02 statistic refits
        # normalization or retrains the network.
        n = len(measurements)
