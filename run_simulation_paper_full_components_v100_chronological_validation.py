...
if __name__ == '__main__':
    ...
    for epoch in range(1, KNET_V2_WARMUP_EPOCHS + 1):
        ...
        if (
            ...
            best_selection_stage = 'kalmannet_v2_Data01_validation_recursive'
